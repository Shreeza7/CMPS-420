...
const blogPosts = [
  {
    ...
    excerpt: "AI is transforming industries and shaping the future. In this post, we explore the implications of AI in our daily lives.",
    link: "/blogs/understanding-ai",
  },
  {
    id: 2,
    title: "The Future of Web Development",
    excerpt: "Web development is evolving rapidly. Discover the latest trends and technologies that are shaping the web.",
